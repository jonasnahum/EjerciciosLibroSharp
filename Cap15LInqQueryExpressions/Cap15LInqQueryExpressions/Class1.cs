...
namespace Cap15LInqQueryExpressions
{
    ...
    public class Alumno
    {
        ...
        public static IEnumerable<Alumno> ObtenerAlumnos()//de typo IEnumerable generico o de <T>
        {
            ...
            alumnos.Add(new Alumno("jonas", 28, 8.4M, "jose", 1, Sexo.masculino));
            alumnos.Add(new Alumno("jonas", 20, 9M, "maria", 1, Sexo.masculino));
            alumnos.Add(new Alumno("juan", 26, 7.4M, "juana", 1,Sexo.masculino));
            alumnos.Add(new Alumno("mary", 18, 6.4M, "Marycruz", 1,Sexo.feminino));
            alumnos.Add(new Alumno("lupe", 16, 8M, "guadalupe", 1,Sexo.feminino));
            alumnos.Add(new Alumno("chole", 30, 5M, "soledad", 2,Sexo.feminino));
            alumnos.Add(new Alumno("amon", 22, 7M, "nenita", 2,Sexo.masculino));
            alumnos.Add(new Alumno("edwin", 15, 7.64M, "ceci", 2,Sexo.masculino));
            alumnos.Add(new Alumno("sandra", 16, 8.6M, "sandra", 2,Sexo.feminino));
            alumnos.Add(new Alumno("vero", 32, 6.5M, "maria", 2,Sexo.feminino));
            alumnos.Add(new Alumno("julieta", 28, 8.4M, "vero", 3,Sexo.feminino));
            alumnos.Add(new Alumno("diego", 14, 8.4M, "Nury", 3,Sexo.masculino));
            alumnos.Add(new Alumno("paul", 15, 6.5M, "estela", 3,Sexo.masculino));
            alumnos.Add(new Alumno("paty", 8, 7.8M, "yolanda", 3,Sexo.feminino));
            alumnos.Add(new Alumno("hugo", 23, 3.0M, "lucrecia", 3,Sexo.masculino));

            alumnos.Add(new Alumno("solovino", 5, 7.8M, "Toby", 13,Sexo.masculino));
            alumnos.Add(new Alumno("pantera", 23, 3.0M, "wera", 13,Sexo.feminino));
