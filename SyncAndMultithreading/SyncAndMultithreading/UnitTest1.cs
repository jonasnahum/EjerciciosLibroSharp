    ...
    public class UnitTest1
    {
        ...
        {LockWithMonitor examples = new LockWithMonitor();//uso de Monitor. para evitar un race condition, y para bloquear yna variable para que solo un hilo accese a ella a la vez.
           ...
           // lwl.RaceCondition();//se dice que esta formula es una abreviacion de monitor.
            ...
            //ResetEvents.ResetEvents.Main();//puede controlar los hilos a gusto, que se detengan y esperen al principal o vice versa., que esperen determinado tiempo,, etc.
            ...
            //tambien para ver un ejemplo de BackgroundWorker EXAMPLE para 2 trheads nomas, que es otro EAP ademas del status, se puede cancelar, marca errores, progreso, etc. este es el mas organizado de los 3 anteriores.
        }
    }
}
